...
```
<script src="https://cdn.jsdelivr.net/npm/number-to-persian@1.0.5/dist/numberToPersian.min.js"></script>
<script>
	console.log(numberToPersian(123)); //output: یکصد و بیست و سه
</script>
```
...
https://cdn.jsdelivr.net/npm/number-to-persian@1.0.5/dist/numberToPersian.min.js
